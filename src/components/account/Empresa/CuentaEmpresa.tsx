      ...
      <div className="w-screen max-h-screen mt-10 grid place-items-center">
        <Form {...signUpForm}>
          <form
            ...
            className="m-10 bg-white p-10 border rounded-md shadow-md flex flex-col gap-4 items-center justify-center py-2 h-full"
          >
            <h1>
              <b>Crear Cuenta</b>
            </h1>
        ...
        <Link to="/account" className="text-[#E67E22] hover:text-black">
          ¿Tienes una cuenta de cliente?
        </Link>
      </div>
    </>
  );
