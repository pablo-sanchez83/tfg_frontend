...
import { Locales, Producto, Horario, TramoHorario, Reservas, FotoLocal, User } from '@/lib/interfaces';
                ...
                <Card className='max-h-[500px] overflow-auto '>
                    ...
                    <CardContent>
                        <form onSubmit={localForm.handleSubmit(handleUpdateLocal)}>
                            ...
                            <Button type="submit" className="mt-4">Actualizar Información</Button>
                        </form>
                    </CardContent>
                </Card>
                ...
                <Card className='max-h-[500px] overflow-auto'>
                    ...
                    <CardContent>
                        <form onSubmit={productoForm.handleSubmit(handleAddProducto)}>
                            ...
                            <Button type="submit" className="mt-4">Agregar Producto</Button>
                ...
                <Card className='max-h-[500px] overflow-auto'>
                    ...
                    <CardContent>
                        <form onSubmit={horarioForm.handleSubmit(handleAddHorario)}>
                            ...
                            <Button type="submit" className="mt-4">Agregar Horario</Button>
                        </form>
                    </CardContent>
                    {horarios.length > 0 && (
                        <CardContent>
                ...
                <Card className='max-h-[500px] overflow-auto'>
                    ...
                    <CardContent>
                        <form onSubmit={tramoHorarioForm.handleSubmit(handleAddTramoHorario)}>
                            ...
                            <Button type="submit" className="mt-4">Agregar Tramo Horario</Button>
                        </form>
                    </CardContent>
                    {tramos.length > 0 && (
                        <CardContent>
                ...
                <Card className='max-h-[500px] overflow-auto'>
                    ...
                    <CardContent>
                        <form onSubmit={fotoForm.handleSubmit(handleAddFoto)}>
                            ...
                            <Button type="submit" className="mt-4">Agregar Foto</Button>
