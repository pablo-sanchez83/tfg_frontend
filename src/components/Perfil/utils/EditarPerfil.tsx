        ...
        <CardContent>
          <Form {...editForm}>
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input
                        placeholder="Teléfono: 9999-999999999"
                        {...field}
                      />
                    </FormControl>
                    {editForm.formState.errors.tel && (
                      <p className="text-red-500">
                        {editForm.formState.errors.tel?.message}
                      </p>
                    )}
                  </FormItem>
                )}
              />
              <Button type="submit">
                Actualizar Información <SquarePen className="ml-2" />
              </Button>
            </form>
          </Form>
          <Dialog>
            <DialogTrigger>
              <Button className="mt-4">
                Editar Contraseña <SquarePen className="ml-2" />
              </Button>
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
              ...
              <Form {...editPasswordForm}>
                <form
                  onSubmit={editPasswordForm.handleSubmit(editPassword)}
                  className="flex flex-col gap-4"
                >
                  <FormField
                  ...
                  />
                  <Button type="submit">
                    Actualizar Contraseña <SquarePen className="ml-2" />
                  </Button>
                </form>
              </Form>
            </DialogContent>
